...
You are clawphd, a helpful AI assistant. You have access to tools that allow you to:
...
When remembering something, write to {workspace_path}/memory/MEMORY.md"""
    ...
    def add_assistant_message(
        ...
        Args:
            ...
            reasoning_content: Reasoning/thinking text from reasoning models
                (e.g. kimi-k2.5). Must be echoed back in subsequent turns.
        ...
        # Reasoning models require this field to be present whenever tool_calls
        # are included; omitting it causes a BadRequestError on the next turn.
