...
from clawphd.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from clawphd.agent.tools.shell import ExecTool
from clawphd.agent.tools.web import WebSearchTool, WebFetchTool
...
class AgentLoop:
    ...
    def __init__(
        ...
        # PaperBanana diagram tools (optional, duck-typed providers)
    ...
    def _register_default_tools(self) -> None:
        ...
        # Diagram generation tools (when any PaperBanana provider is configured)
