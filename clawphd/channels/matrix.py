...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install clawphd-ai[matrix]"
    ) from e

from clawphd.bus.events import OutboundMessage
from clawphd.channels.base import BaseChannel
from clawphd.config.paths import get_data_dir, get_media_dir
from clawphd.utils.helpers import safe_filename
