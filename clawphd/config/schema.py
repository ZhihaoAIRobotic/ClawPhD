...
class SemanticScholarConfig(Base):
    """Semantic Scholar / paper search configuration."""

    api_key: str = ""


class DiagramToolsConfig(Base):
    """PaperBanana diagram tool configuration."""
...
class Config(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="CLAWPHD_", env_nested_delimiter="__")
