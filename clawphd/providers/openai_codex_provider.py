...
def _get_codex_token():
    """Lazy import of oauth_cli_kit to avoid hard dependency at package load time."""
    try:
        from oauth_cli_kit import get_token
        return get_token
    except ImportError as exc:
        raise ImportError(
            "oauth_cli_kit is required for OpenAI Codex provider. "
            "Install it with: pip install oauth-cli-kit"
        ) from exc

DEFAULT_CODEX_URL = "https://chatgpt.com/backend-api/codex/responses"
DEFAULT_ORIGINATOR = "clawphd"
